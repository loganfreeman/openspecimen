...
public class DistributionOrderFactoryImpl implements DistributionOrderFactory {
	...
	private DistributionOrderItem getOrderItem(
		...
		if (detail.getQuantity() == null) {
			ose.addError(DistributionOrderErrorCode.QTY_REQ, specimen.getLabel());
			return null;
		}

		if (NumUtil.lessThanEqualsZero(detail.getQuantity())) {
			ose.addError(DistributionOrderErrorCode.INVALID_QUANTITY, specimen.getLabel());
			return null;
		}
